...
def get_data(filename, other=2):
    ...
    try:
        ...
        datax = pd.read_csv("data/xpos.csv", skipinitialspace=True)
    ...
    return data, datax, num_positions, num_times


def extract_position(data, datax, i=0, other=2):
    ...
    x_positions = np.array(rowx[other:]).flatten()
...
def main():
    ...
    data, datax, num_positions, num_times = get_data(filename)
